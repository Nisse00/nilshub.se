        ...
        <div className="container">
            <div className="row" style={{ marginTop: "20px", alignItems: "center" }}>
                ...
                <div className="color-coding">
                    <span style={{ backgroundColor: "green", display: "inline-block", width: "20px", height: "20px", marginRight: "5px", marginLeft: "10px" }}></span> Free to book
                    <span style={{ backgroundColor: "gray", display: "inline-block", width: "20px", height: "20px", marginRight: "5px", marginLeft: "10px" }}></span> Unavailable
                    <span style={{ backgroundColor: "red", display: "inline-block", width: "20px", height: "20px", marginRight: "5px", marginLeft: "10px" }}></span> Booked by someone else
                    <span style={{ backgroundColor: "blue", display: "inline-block", width: "20px", height: "20px", marginRight: "5px", marginLeft: "10px" }}></span> Your current booking
                </div>
                </div>
                <div className="col-auto">
                    <button
